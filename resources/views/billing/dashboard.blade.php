        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <nav class="hidden sm:flex sm:space-x-8">
                    <x-nav-link :href="route('billing.dashboard')" :active="request()->routeIs('dashboard')">
                        {{ __('Dashboard') }}
                    </x-nav-link>
                </nav>
            </div>
    ...
    <main class="py-10 bg-gradient-to-br from-gray-50 via-white to-gray-100 min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
            ...
            <div class="flex items-center justify-between">
                <h1 class="text-3xl font-bold text-gray-800 tracking-tight">Billing Clerk Dashboard</h1>
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
                        <div class="flex items-center gap-5">
                            ...
                            <div class="relative">
                                ...
                                <img src="{{ Auth::user()->profile_photo_url ?? asset('img/billing.png') }}"
                            ...
                            <div class="bg-white/80 backdrop-blur-md px-4 py-2 rounded-xl shadow-sm border border-gray-100">
                                <h2 class="text-2xl sm:text-3xl font-bold text-gray-900 tracking-tight">
                                    {{ Auth::user()->name ?? 'billing User' }}
                                </h2>
                                <p class="text-sm text-gray-600 mt-1">
                                    {{ Auth::user()->email ?? 'billing@example.com' }}
                                </p>
                                <span
                                    ...
                                    <i class="fa-solid fa-shield-alt text-[11px]"></i> Billing Clerk
                                </span>
                            </div>
                        </div>
                        ...
                        <!-- Profile Actions -->
                        <div class="flex items-center gap-3">
                            <a href="{{ route('billing.profile-settings') }}"
